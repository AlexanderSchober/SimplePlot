...
try:
    try:
        ...
        from .CompiledRessources import MaccContourCalculations as CCalc

    except:
        
        print('Mac import Failed')
        from .CompiledRessources import LinuxcContourCalculations as CCalc
except:

    print('both mac and Linux failed')
    from .CompiledRessources import ContourCalculations as CCalc

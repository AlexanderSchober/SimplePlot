...
class SettingsClass:
    ...
    def Creator(self):
        ...
        #set the frame
        self.frame = tkinter.ttk.Frame(self.Window, padding = '10p')
...
class SettingWindow:
    ...
    def PopulateMainFrame(self):
        ...
        ####################
        #Selector frame
        self.SelectorTopFrame = tkinter.ttk.Frame(self.frame)
        ...
        self.SelectorDrop = tkinter.ttk.OptionMenu(self.SelectorTopFrame,
                                           self.SelectorVar,
                                           self.List[0],
                                           *self.List,
        ...
        #create the label
        self.SelectorLabel_0 = tkinter.ttk.Label(self.SelectorTopFrame,
        ...
        ####################
        #content frame
        self.SelectorBotFrame = tkinter.ttk.Frame(self.frame)
        ...
        ####################
        #Apply frames
        self.ButtonBotFrame = tkinter.ttk.Frame(self.frame)
            
        self.CloseButton = tkinter.ttk.Button(self.ButtonBotFrame,
                                      command = self.Close,
                                      text = 'Close')
                                      
        self.ResetButton = tkinter.ttk.Button(self.ButtonBotFrame,
                                      command = self.Reset,
                                      text = 'Reset')
                                      
        self.ApplyButton = tkinter.ttk.Button(self.ButtonBotFrame,
                                      command = self.Apply,
                                      text = 'Apply')
    ...
    def BuildNoteBooks(self, TargetFrame, SubPlot = 0):
        ...
        self.NoteBookFrame = tkinter.ttk.Frame(TargetFrame)
        
        self.NoteBook = tkinter.ttk.Notebook(self.NoteBookFrame)
    ...
    def BuildSettingFrame(self,Target, Title = ''):
        ...
        '''
        #create the frame
        ReturnFrame = tkinter.ttk.Frame(Target, padding = '10p')
...
class SettingWindowSave:
    ...
    def BuildSaveSetting(self,Target):
        ...
        self.PoisitionMatrix.append([tkinter.ttk.Button(Target,
                                                text = 'Select Path',
        ...
        self.DirLabel = tkinter.ttk.Label(Target,
        ...
        self.PoisitionMatrix.append([tkinter.ttk.Label(Target,
                                               text = 'Name:',
                                               anchor = E,
        ...
        self.NameEntry = tkinter.ttk.Entry(Target)
        ...
        self.PoisitionMatrix.append([tkinter.ttk.Checkbutton(Target,
...
class SettingWindowAxes:
    ...
    def BuildAxesSetting(self,Target):
        ...
        for i in range(0,4):
            ...
            #create the entry
            self.PaddingOutEntries[i] = tkinter.ttk.Entry(Target,
                                                  width = 5)
        ...
        for i in range(0,4):
            ...
            #create the entry
            self.PaddingInEntries[i] = tkinter.ttk.Entry(Target,
                                                 width = 5)
        ...
        for i in range(0,len(self.AxisOnOff)):
            ...
            #create the entry
            self.AxisOnOff[i] = tkinter.ttk.Checkbutton(Target,
        ...
        self.ImagingTypeDrop = tkinter.ttk.OptionMenu(Target,
                                              self.ImagingType,
...
class SettingWindowTicks:
    ...
    def BuildTicksSetting(self,Target):
        ...
        for i in range(0,len(self.TickOnOff)):
            ...
            #create the entry
            self.TickOnOff[i] = tkinter.ttk.Checkbutton(Target,
        ...
        for i in range(0,len(self.TickPointer)):
            ...
            for j in range(0,len(self.TickPointer[i])):
                ...
                #create the entry
                self.TickPointer[i][j] = tkinter.ttk.Entry(Target,
                                                   width = 5)
        ...
        for i in range(0,len(self.LabelOnOff)):
            ...
            #create the entry
            self.LabelOnOff[i] = tkinter.ttk.Checkbutton(Target,
        ...
        for i in range(0,len(self.SizeEntry)):
            ...
            #create the entry
            self.SizeEntry[i] = tkinter.ttk.Entry(Target,
                                          width = 5)
        ...
        for i in range(0,len(self.FontEntry)):
            ...
            #create the entry
            self.FontEntry[i] = tkinter.ttk.Entry(Target,
                                          width = 8)
        ...
        for i in range(0,len(self.AngleEntry)):
            ...
            #create the entry
            self.AngleEntry[i] = tkinter.ttk.Entry(Target,
                                          width = 3)
        ...
        for i in range(0,len(self.AngleEntry)):
            ...
            #create the entry
            self.OffsetEntry[i] = tkinter.ttk.Entry(Target,
                                          width = 3)
        ...
        for i in range(0,len(self.ScientificOnOff)):
            ...
            #create the entry
            self.ScientificOnOff[i] = tkinter.ttk.Checkbutton(Target,
            ...
            #create the entry
            self.ScientificPrecision[i] = tkinter.ttk.Entry(Target,
                                                    width = 5)
...
class SettingWindowPointer:
    ...
    def BuildPointerSetting(self,Target):
        ...
        #Create the two elements
        self.PointerTypeDrop = tkinter.ttk.OptionMenu(Target,
                                              self.PointerType,
                                              self.PointerTypeList[0],
                                              *self.PointerTypeList)
                                                      
        self.PointerLabelTypeDrop = tkinter.ttk.OptionMenu(Target,
...
#                                     E+W,1,1])
        ...
        #create the entry
        self.ScientificOnOffX = tkinter.ttk.Checkbutton(Target,
        ...
        #create the entry
        self.ScientificPrecisionX = tkinter.ttk.Entry(Target,
                                             width = 2)
        ...
        #create the entry
        self.ScientificOnOffY = tkinter.ttk.Checkbutton(Target,
        ...
        #create the entry
        self.ScientificPrecisionY = tkinter.ttk.Entry(Target,
                                             width = 2)
        ...
        #create the entry
        self.Length = tkinter.ttk.Entry(Target,
                                width = 2)
        ...
        #create the entry
        self.Width = tkinter.ttk.Entry(Target,
                                width = 2)
        ...
        #create the entry
        self.Color = tkinter.ttk.Entry(Target,
                                width = 2)
...
class SettingWindowData:
    ...
    def CatchDataSetting(self,Object,Target):
        ...
        for i in range(0, len(Object.Plots)):
            ...
            tempVar = IntVar()
            tempVar.set(1)
            LocalList.append(tkinter.ttk.Checkbutton(Target, variable = tempVar))
            ...
            ###################################
            #place the type
            LocalList.append(tkinter.ttk.Label(Target,text = '2D Plot'))
            ...
            LocalList.append(tkinter.ttk.Label(Target,text = text))
            ...
            LocalList.append(tkinter.ttk.Entry(Target,
                                       width = 3))
        ...
        for i in range(0, len(Object.Ranges)):
            ...
            ###################################
            #place the type
            LocalList.append(tkinter.ttk.Label(Target,text = 'Range'))
        ...
        for i in range(0, len(Object.Lines)):
            ...
            ###################################
            #place the type
            LocalList.append(tkinter.ttk.Label(Target,text = 'Line'))

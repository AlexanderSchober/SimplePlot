...
class Measure:
    ...
    def Listen(self):
        ...
        self.BoundMethod_0 = self.Canvas.bind('<Button-1>', self.Onset,'+')
        
        #start the motion lister as well as the kill listener
        self.BoundMethod_1 = self.Canvas.bind('<ButtonRelease-1>'   , self.DeleteCursors      ,'+')
        
        #link the method
        self.Canvas.Drawer.Mouse.Bind('<B1-Motion>',self.MoveCursor,'Pointer')
    ...
    def Onset(self,event):
        ...
        self.Line = self.Canvas.create_line(self.StartPositionsScale[0],

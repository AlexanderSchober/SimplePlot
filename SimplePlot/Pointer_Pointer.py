            ...
            if self.LabelPositions[0]:
                self.LeftPointerLabel = self.Canvas.create_text(#X
                                                                ...
                                                                *self.Canvas.Drawer.wScaleFactor,
                                                                ...
                                                                font  = self.FontSize,
                                                                text  = str(numpy.round(0.5,self.Rounding)),
                                                                tag   = 'TopTop')
            ...
            if self.LabelType == 0:
                ...
                if self.LabelPositions[0]:
                    ...
                    if self.isYSci:
                        ...
                        self.Canvas.itemconfig(self.LeftPointerLabel,
                                               text = str(numpy.round(self.Cursor_y,self.Rounding)))
                ...
                if self.LabelPositions[1]:
                    ...
                    if self.isXSci:
                        ...
                        self.Canvas.itemconfig(self.BotPointerLabel,
                                               text = str(numpy.round(self.Cursor_x,self.Rounding)))
            ...
            if self.LabelType == 2:
                ...
                if self.LabelPositions[0]:
                    ...
                    if self.isYSci:
                        ...
                        self.Canvas.itemconfig(self.LeftPointerLabel, text = 'Y = '+str(numpy.round(self.Cursor_y,self.Rounding)))
                ...
                if self.LabelPositions[1]:
                    ...
                    if self.isXSci:
                        ...
                        self.Canvas.itemconfig(self.BotPointerLabel, text = 'X = '+str(numpy.round(self.Cursor_x,self.Rounding)))
                ...
                if self.LabelPositions[2]:
                    ...
                    if self.isYSci:
                        ...
                        self.Canvas.itemconfig(self.RightPointerLabel, text = 'Y = '+str(numpy.round(self.Cursor_y,self.Rounding)))
                ...
                if self.LabelPositions[3]:
                    ...
                    if self.isXSci:
                        ...
                        self.Canvas.itemconfig(self.TopPointerLabel, text = 'X = '+str(numpy.round(self.Cursor_x,self.Rounding)))
